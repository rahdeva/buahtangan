...
import 'package:buahtangan/app/modules/gift-directory/widgets/gift_grid_builder.dart';
...
class GiftDirectoryView extends StatelessWidget {
  const GiftDirectoryView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<GiftDirectoryController>(
      builder: (controller) {
